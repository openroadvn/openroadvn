		...
		<div id="node-information" class="box information">
			...
			<div class="odd nodes-row-first nodes-row-last clearfix">
				<dl class="colspans-4-4 first last fields">
					<?php if ($node->field_case_logo): ?>
						<dt class="field field-logo-term"><?php print t('Logo'); ?>:</dt>
						<dd class="field field-logo-description"><?php print theme_imagecache('community_logo', $node->field_case_logo['0']['filepath'], $node->title . ' logo', $node->title); ?>&nbsp;</dd>
					<?php endif; ?>
					<?php foreach ($case_info as $id => $terms): ?>
						<?php if ($terms): ?>
							<dt class="field field-case-info-term"><?php print t($id); ?>:</dt>
							<dd class="field field-case-info-description"><?php print $terms; ?></dd>
						<?php endif; ?>
					<?php endforeach; ?>
