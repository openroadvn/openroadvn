		...
		<div id="breadcrumb-wrapper">
			<div id="breadcrumb" class="fluid clearfix">
				<div class="colspan-16">
					...
					<p><strong><a href="http://opentechnologyfoundation.org/">OTF</a> &raquo; <?php if ($breadcrumb): print $breadcrumb; endif; ?></strong></p>
				</div>
			</div>
		</div>
...
<div class="block clearfix"><a href="/sites/default/files/Simple_%20Privacy_Framework_Summary.pdf" TARGET="_new"><img width="30px" height="30px" src="/drupal/sites/all/themes/joinup/images/icons/PrivacyRating2.png"/></a></div>				
