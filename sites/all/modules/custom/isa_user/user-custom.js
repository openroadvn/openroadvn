...
Drupal.behaviors.password = function(context) {
  ...
  $("input.password-field:not(.password-processed)", context).each(function() {
    ...
    var passwordCheck = function () {
      ...
      //SGS change class for low : error to warning
	  var classMap = { low: "warning", medium: "warning", high: "ok" };
...
Drupal.evaluatePasswordStrength = function(value) {
  ...
  // Password is not secure enough so construct the medium-strength message.
    ...
    msg = translate.needsMoreVariation +"<ul><li>"+ msg.join("</li><li>") +"</li></ul>"+translate.needsMoreVariationFooter;
  }
