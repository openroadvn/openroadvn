 ...
 * for you.
 */
 $base_url = 'http://openroad.vn';  // NO trailing slash!
...
$conf['isa_ml_domain'] = 'openroad.vn';
...
$conf['simplenews_test_address'] = 'tinh.huynhviet@lactien.com';
$conf['site_mail'] =
$conf['subscriptions_site_mail'] = 'tinh.huynhviet@lactien.com';

$conf['user_mail_status_blocked_body'] = sprintf("Dear [recipient-firstname], Your account has been blocked. In case of error, you can contact us thanks to the address %s. !site Team", $conf['site_mail']);
